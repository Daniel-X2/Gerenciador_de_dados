...
def descriptografar_arquivo(nome_arquivo_criptografado,nome_arquivo_saida,senha):
    ...
    with open(nome_arquivo_saida,"wb") as f:
        f.write(dados)
n1="/home/daniel/Desktop/PROJETOS/PYTHON/novo projeto/txt.txt"
n2="/home/daniel/Desktop/PROJETOS/PYTHON/novo projeto/saida.bin"
n3="txt_des.txt" 

criptografar_arquivo(nome_arquivo=n1,senha="123456789")
